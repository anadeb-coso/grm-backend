...
urlpatterns = [
    ...
    path('datatable/', views.AdlListDatatableJsonView.as_view(), name='list_datatable'),
    path('create-profile/', views.CreateAdlGovernmentWorkerProfileFormView.as_view(), name='create_profile'),
