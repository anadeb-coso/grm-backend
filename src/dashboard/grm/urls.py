...
urlpatterns = [
    ...
    path('issue-reasons-decrypt/<int:issue>/', views.IssueReasonsDecryptListView.as_view(), name='issue_reasons_decrypt'),
    ...
    path('submit-issue-research-result/<int:issue>/', views.SubmitIssueResearchResultFormView.as_view(),
     ...
     path('submit-issue-set-unresolved/<int:issue>/', views.SubmitIssueSetUnresolvedFormView.as_view(),
         name='submit_issue_set_unresolved'),
     path('submit-issue-escalate/<int:issue>/', views.SubmitIssueEscalateFormView.as_view(),
         name='submit_issue_escalate'),
     path('submit-issue-publish/<int:issue>/', views.SubmitIssuePublishFormView.as_view(),
         name='submit_issue_publish'),
     path('submit-issue-unpublish/<int:issue>/', views.SubmitIssueUnpublishFormView.as_view(),
         name='submit_issue_unpublish'),
